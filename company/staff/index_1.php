...
Наш коллектив – это сплоченная, профессиональная команда. Мы считаем, что собственное жилье должно быть доступно каждому и, невзирая на нестабильную ситуацию на рынке недвижимости, продолжаем радовать людей качественным жильем! Мы открыты для диалога и готовы обсуждать предложения о сотрудничестве, усовершенствовании нашего сервиса и внедрении новых услуг. Задать вопрос нашим специалистам можно через форму обратной связи.

<div class="section-footer">
	<a class="btn btn-primary" href="/ajax/request.php" data-toggle="modal">Написать нам</a>
</div>

<? $APPLICATION->IncludeComponent("bitrix:news.list", "staff-section", Array(
	...
	"PAGER_TITLE" => "сотрудники",	// Nazvanie kategoriy
