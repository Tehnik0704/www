...
$APPLICATION->SetTitle(Loc::getMessage("PHOTO_GALLERY_TITLE"));

const IBLOCK_GALLERY = "complex_gallery";

$galleryFilter = array();
$galleryFilter['SECTION_ID'] = ForeignIblock::getSectionId($component->getJhk(), IBLOCK_GALLERY);
$galleryFilter['INCLUDE_SUBSECTIONS'] = 'Y';
    ...
    <div class="w">
        <div class="section-inner">
            <header class="section__header">
                ...
                <div class="section-description"><?= JkFormatter::format(Loc::getMessage("PHOTO_GALLERY_DESCRIPTION"), $component->getJhk(), [JkFormatter::CASE_LOWER, \Citrus\Core\Morpher::CASE_R]) ?></div>
            </header>
            ...
            <? /*$APPLICATION->IncludeComponent(
                ...
                array(
                    'DATA' => array(
                        ...
                        "PHOTO_SECTION_ID" => ForeignIblock::getSectionId($component->getJhk(), IBLOCK_GALLERY),
            ...
            <?
            $GLOBALS['PROGRESS_FILTER'] = $galleryFilter;
            ?>
            <? #progress list
            ?>
            <? $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "IBLOCK_ID" => Iblock::getId(IBLOCK_GALLERY),
                    "IBLOCK_TYPE" => "jhk",
