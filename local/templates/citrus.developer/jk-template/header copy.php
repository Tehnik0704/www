                ...
                <div class="h__inner">
                    <a
                       ...
                       id="<?=Action::editIBlockElement($complex, $complex->getJhk('ID'))?>">
	                    ...
	                    <span class="logo__text">
                            <span class="logo__text-1"><?=JkFormatter::format('#TYPE_FULL#', $complex->getJhk())?></span>
                    ...
                    <div class="h__right">
                        <div class="h__right-1">
                            ...
                            <a href="javascript:void(0);" data-href="<?=SITE_DIR?>ajax/order_call.php" class="h__order-call print-hidden" data-toggle="modal">
